            ...
            <Navbar className="sticky min-w-full top-0 z-10 h-max rounded-none px-4 py-1 lg:px-8  ">
                <div className="flex w-full items-center justify-between text-blue-gray-900">
                    <div className=" flex items-center w-[150px] h-[40px] " >
                        <Image src="/logo1.png" alt="logo" onClick={()=> router.push("/")} width={70} height={50} className=" rounded-lg cursor-pointer  " />
                    <Typography
                        className=" py-1.5 font-medium text-2xl  whitespace-nowrap"
                    >
                        คอร์สออนไลน์
                    </Typography>
                    </div>
                    <div className="flex items-center gap-4  whitespace-nowrap ">
                        ...
                        <div className="flex ">
                            ...
                            {login ? (
                                <HeaderButton href="/home" variant="outlined">ออกจากระบบ</HeaderButton>
                ...
                <Collapse open={openNav}>
                    ...
                    <div className="flex items-center justify-center gap-x-1">
                        ...
                        <Button fullWidth variant="outlined" color="purple" size="sm" className="mb-3" onClick={() => router.push('/home')}>
