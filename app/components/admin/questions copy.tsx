...
//   const [dataTable, setDataTable] = useState<ResponseData2>({
//     data: [],
//     totalPages: 1,
//   });
...
//   const handleCategoryChange1 = (id: any) => {
//     const selectedProductId = id || 0;
//     dispatch({
//       type: "SET_FORM_DATA",
//       payload: { product_id: selectedProductId },
//     });
...
//   const handleChapterChange1 = (id: any) => {
//     const selectedChapterId = id || null;
//     dispatch({
//       type: "SET_SELECTED_CHAPTER",
//       payload: selectedChapterId,
//     });
...
//   useEffect(() => {
//     fetchQuestion();
//   }, [fetchQuestion, page,searchQuery]);

//   const fetchList1 = useCallback(async (products_id ,products_title_id,new_question_id) => {
//     const requestData = {
//       products_id: select1?.value || select1,
//       products_title_id: select2?.value || select2,
//       page: pageList,
//       search: searchList,
//       full: false,
//       new_question_id: null || selectId,
...
//               value: option?.products_id,
//               label: option?.products_title,
//               title: option?.products_title_id,
//               id: option?.id,
//             }))}
//             //   onChange={(selectedOption) =>
//             //     setDataSelect(selectedOption?.value || "")
//             //   }
//             onChange={(selectedOption) => [
//               handleCategoryChange1(selectedOption?.value),
//               handleChapterChange1(selectedOption?.title),
//               setSelect1(selectedOption?.value),
//               setSelect2(selectedOption?.title),
//               setSelectId(selectedOption?.id),
//             ]}
//             placeholder="คำถาม"
//             isClearable
//             styles={{
...
//                 ...provided,
//                 borderRadius: "8px", // Border radius of the input
//                 backgroundColor: "#f4f2ff", // Background color
//                 borderColor: state.isFocused ? "#673AB7" : "#673AB7", // Border color on focus
//                 boxShadow: state.isFocused
//                   ? "0 0 0 1px #673AB7"
//                   : provided.boxShadow, // Focus shadow
//                 "&:hover": {
//                   borderColor: state.isFocused
//                     ? "#673AB7"
//                     : provided.borderColor, // Hover border color
//                 },
//               }),
//               placeholder: (provided) => ({
//                 ...provided,
//                 color: "#673AB7", // Placeholder color
//               }),
//               singleValue: (provided) => ({
//                 ...provided,
//                 color: "#673AB7", // Color of the selected option
//               }),
//               menu: (provided) => ({
//                 ...provided,
//                 borderRadius: "8px", // Menu border radius
//                 color: "#673AB7", // Menu text color
//               }),
...
//                   ? "#8d80d0"
//                   : state.isFocused
//                   ? "#e6e0f3" // Hover background color
//                   : "#ffffff", // Default background color
//                 color: state.isSelected ? "#ffffff" : provided.color, // Selected text color
//                 "&:hover": {
//                   backgroundColor: "#e6e0f3", // Background color on hover
...
//           />
//         </div>
//         <Card className="flex w-full p-3 mt-5 overflow-auto">
//           <div className="flex flex-col  lg:flex-row mt-3  gap-3 ">
//             <div className="flex items-center gap-2 ">
//               <HiOutlineChatAlt2 className="text-xl" />
//               <Typography className="font-semibold">ขอคำถามชุดใหม่</Typography>
//             </div>
//           </div>
...
//                             onClick={() => [
//                               setSelect1(item?.products_id),
//                               setSelect2(item?.products_title_id),
//                               setSelectId(item?.id),
//                               handleCategoryChange1(item?.products_id),
//                               handleChapterChange1(item?.products_title_id),
//                               fetchList1()
//                             ]}
//                           >
//                             {item?.products_title}
...
//               หน้าที่ {page1} / {data?.totalPages || 1}{" "}
//             </span>
//             <button
//               className={`text-gray-400 text-2xl whitespace-nowrap rounded-full border border-gray-300 shadow-md ${
