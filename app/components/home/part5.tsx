...
const Part5 = () => {
  return (
    <div className="bg-[#222222]  py-10 px-6 h-full border-t-gray-800 border-t-[1px]   2xl:px-[250px]">
      <h2 className="text-white text-[35px]  font-[500] text-center mb-10">
        เรียนเทรดกับเราดีอย่างไร
      </h2>

      <div className="flex flex-col lg:flex-row items-center gap-16 2xl:gap-0 w-full lg:w-10/12 mx-auto">
        {/* วิดีโอด้านซ้าย */}
        ...
        <div className="flex flex-col items-start text-white space-y-8 text-left lg:w-6/12">
          <div>
            ...
            <p className="text-[17px] text-[#a3a3a3] font-light">
