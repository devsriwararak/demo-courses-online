        ...
        >
          ...
          <div className="p-4 px-7">
            ...
            <div className="flex gap-3 items-center">
              ...
              <span className="text-[14px] font-[400]  text-[#181818]">12 พ.ค. 2024</span>
            </div>
          </div>
        </div>

        {/* บล็อกข่าวทางขวา */}
        <div className="flex flex-col lg:w-7/12  gap-11 lg:mt-[33px] xl:mt-[80px] 2xl:mt-[80px]  ">
          {/* ข่าวที่ 1 */}
          <div className="w-full flex flex-col xl:flex-row gap-3 rounded-xl ">
            ...
            />
            <div>
            <div className="p-2 flex flex-col bg-[#cdcdcd]  rounded-lg px-7">
              <h3 className="text-[16px] sm:text-[18px] font-[700]  text-[#093165]  mb-4 ">
